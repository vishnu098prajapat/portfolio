...
export const profileData: ProfileData = {
  personalInfo: {
    ...
    location: "India",
    avatar: "/src/public/image/m3.JPG",
    email: "vishanuprajapati888@gmail.com",
    phone: "+91 6377749427",
    linkedin: "https://www.linkedin.com/in/vishprajapattt/",
  ...
  skills: [
    ...
    { name: "Data Science", endorsement: 10 },
  ],
  projects: [
    {
      name: "Sparrowfy",
      ...
      imageUrl: "/src/public/image/Untitled design.png",
    ...
    },
    {
      ...
      description: "Smart automation tool for Instagram that auto-replies to comments and handles direct messages (DMs) to boost engagement.",
      technologies: ["React", "Automation"],
      imageUrl: "/src/public/image/insta.jpg",
    ...
    },
    {
      ...
      imageUrl: "/src/public/image/online-game.jpeg",
