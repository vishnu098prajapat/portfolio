  ...
  projects: [
    {
      ...
      imageUrl: "/src/public/image/aiquizcraft.png",
    ...
    },
    {
      ...
      description: "Smart automation tool for Instagram that auto-replies to comments and handles direct messages (DMs) to boost engagement using React.",
